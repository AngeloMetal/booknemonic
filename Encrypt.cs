...
namespace Booknemonic
{
    public partial class Encrypt : Form
    {
        ...
        {
            string[] lines = Regex.Split(allEnglishWords, @","); ;
            return lines;
        }
